...
This guide applies to ImplingFinder work:

- `implingfinder/`
- `tests/test_implingfinder_*.py`
...
- Keep bundled asset names aligned with `ImplingSpawn.type_key`: `magpie.png`,
  `ninja.png`, `crystal.png`, `dragon.png`, and `lucky.png`.
...
6. For dashboard changes, populate sample metrics and inspect desktop and
   mobile layouts before deployment.
